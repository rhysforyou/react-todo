...
describe('TodoItem', () => {
  it('forwards click events to its `onClick` property', () => {
    ...
    const wrapper = Enzyme.shallow(
      <TodoItem title="Test Item" completed={false} onClick={onClick} />
    )
    wrapper.find('.todo-list-item input[type="checkbox"]').simulate('change')
  ...
  describe('`completion` property', () => {
    it("applies the 'completed' class if present", () => {
      const wrapper = Enzyme.shallow(
        <TodoItem title="Test Item" completed={true} />
      )
    ...
    it("applies the 'incomplete' class if absent", () => {
      const wrapper = Enzyme.shallow(
        <TodoItem title="Test Item" completed={false} />
      )
